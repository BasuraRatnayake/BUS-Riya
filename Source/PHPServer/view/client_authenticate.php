...
if(isset($_POST['username'], $_POST['password'])){
    ...
    $noOfRows = $database->numberOfRecords("username, password", "client_login", "WHERE username = '$username' AND password = '$password'");
    ...
    $username = $core->cleanInput($_POST['username']);
    $noOfRows = $database->numberOfRecords("username, refreshToken", "tbl_tokens_client", "WHERE username = '$username' AND refreshToken = '$refreshToken'");
